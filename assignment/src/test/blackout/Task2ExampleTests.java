...
public class Task2ExampleTests {
    ...
    public void testEntitiesInRange() {
        ...
        controller.createDevice("DeviceE", "DesktopDevice", Angle.fromDegrees(311));
        controller.createSatellite("Satellite3", "StandardSatellite", 2000 + RADIUS_OF_JUPITER, Angle.fromDegrees(175));

        assertListAreEqualIgnoringOrder(Arrays.asList("DeviceB", "DeviceC", "DeviceE", "Satellite2"), controller.communicableEntitiesInRange("Satellite1"));
        ...
        assertListAreEqualIgnoringOrder(Arrays.asList("Satellite1"), controller.communicableEntitiesInRange("DeviceE"));
